...
const env={DB:{prepare:()=>({bind:()=>({first:async()=>article})})},ASSETS:{fetch:async()=>Response.json([{id:'atlas-test',name:'Медіа тест',newsIds:['atlas-test','legacy-id'],url:'https://atlas.promedia.report/media/atlas-test'}])}};
...
try{
 ...
 assert.ok(html.includes('https://atlas.promedia.report/media/atlas-test'));
